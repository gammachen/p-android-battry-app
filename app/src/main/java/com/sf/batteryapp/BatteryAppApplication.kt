...
import com.sf.batteryapp.worker.AppBatteryUsageWorker
import com.sf.batteryapp.worker.BatteryHealthWorker
import com.sf.batteryapp.worker.BatteryUsageWorker
...
class BatteryAppApplication : Application() {
    ...
    private fun clearTestData() {
        ...
        val viewModel = androidx.lifecycle.ViewModelProvider.AndroidViewModelFactory(this)
            .create(com.sf.batteryapp.viewmodel.BatteryViewModel::class.java)
