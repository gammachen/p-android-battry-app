...
class ChargingSessionAdapter(
    ...
    override fun onBindViewHolder(holder: ChargingSessionViewHolder, position: Int) {
        ...
        val modeText = when (session.chargingMode) {
            com.sf.batteryapp.model.ChargingMode.Mode.TRICKLE.name -> holder.itemView.context.getString(R.string.charging_mode_trickle)
            com.sf.batteryapp.model.ChargingMode.Mode.SLOW.name -> holder.itemView.context.getString(R.string.charging_mode_slow)
            com.sf.batteryapp.model.ChargingMode.Mode.NORMAL.name -> holder.itemView.context.getString(R.string.charging_mode_normal)
            com.sf.batteryapp.model.ChargingMode.Mode.FAST.name -> holder.itemView.context.getString(R.string.charging_mode_fast)
            com.sf.batteryapp.model.ChargingMode.Mode.SUPER_FAST.name -> holder.itemView.context.getString(R.string.charging_mode_super_fast)
            com.sf.batteryapp.model.ChargingMode.Mode.ULTRA_FAST.name -> holder.itemView.context.getString(R.string.charging_mode_ultra_fast)
