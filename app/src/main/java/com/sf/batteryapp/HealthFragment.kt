...
class HealthFragment : Fragment() {
     ...
     * 更新充电习惯分析UI
     */
    private fun updateChargingHabitsAnalysisUI(analysis: com.sf.batteryapp.model.ChargingHabitsAnalysis) {
        // 更新充电习惯统计数据
     ...
     * 更新充电记录列表UI
     */
    private fun updateChargingSessionsUI(sessions: List<com.sf.batteryapp.model.ChargingSession>) {
        // 创建并设置适配器
